...
POWERFUL_ACTIONS = ['iam:PutGroupPolicy', 'iam:PutRolePolicy', 'iam:PutUserPolicy', 'iam:CreatePolicy', 'iam:CreatePolicyVersion', 'iam:AttachGroupPolicy', 'iam:AttachRolePolicy', 'iam:AttachUserPolicy']
